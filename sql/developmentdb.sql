...
VALUES
    ('Pancakes', 'Flour, eggs, milk, sugar', 'Delicious pancakes for breakfast', 'Mix all ingredients, fry on a pan', 'Breakfast', 'Not Specified', 'Not Specified', 2, '/img/recipes/pancakes.jpg', 'Approved'),
    ('Spaghetti Carbonara', 'Spaghetti, eggs, pancetta, black pepper, Parmesan cheese', 'Classic Italian pasta dish', 'Boil spaghetti, fry pancetta, mix eggs and cheese, toss together', 'Dinner', 'Not Specified', 'Italian', 2, '/img/recipes/carbonara.jpg', 'Approved'),
    ...
    ('Chocolate Cake', 'Flour, Sugar, Cocoa Powder, Eggs', 'Decadent chocolate cake.', '1. Mix flour, sugar, cocoa powder, and eggs. 2. Bake in the oven.', 'Dessert', 'Not Specified', 'Not Specified', 2, '/img/recipes/cake.jpg', 'Approved'),
